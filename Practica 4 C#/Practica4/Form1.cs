    ...
    public partial class Form1 : Form
    {
        ...
        private void EnemyPlayTimerEvent(object sender, EventArgs e)
        {
            ...
            if (round < 1 || enemyScore > 2 || playerScore > 2)
            {
                ...
                {
                    MessageBox.Show("Hundieron tu barco", "PERDISTE!!");
                    RestartGame();
                }
                else if (enemyScore == playerScore)
                {
                    MessageBox.Show("Nadie gano volver a jugar", "reiniciar");
                    RestartGame();
                }
            }
        ...
        private void AttackButtonEvent(object sender, EventArgs e)
        {
            if (EnemyLocationListBox.Text != "")
            {
                ...
                if (enemyPositionButtons[index].Enabled && round > 0)
                {
                    ...
                    if ((string)enemyPositionButtons[index].Tag == "Enemigo")
                    {
            ...
            {
                MessageBox.Show("Escoge la posicion de tu barco", "Informacion");
            }
        }
        ...
        private void PlayerPositionButtonsEvent(object sender, EventArgs e)
        {
            ...
            if (totalShips == 0)
            {
                ...
                txtHelp.Text = "2) Escoge la posicion de ataque";
            }
        ...
        private void RestartGame()
        {
            ...
            txtHelp.Text = "1) Escoge una posicion Diferente para iniciar!";
        ...
        private void enemyLocationPicker()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                if (enemyPositionButtons[index].Enabled == true && (string)enemyPositionButtons[index].Tag == null)
                {
                    ...
                    Debug.WriteLine("Posicion del enemigo: " + enemyPositionButtons[index].Text);
                }
                else
                {
